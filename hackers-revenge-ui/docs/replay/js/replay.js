...
var updateSize = function(e) {
	var sf = Math.min(window.innerWidth * window.devicePixelRatio / 1920, window.innerHeight * window.devicePixelRatio / 1080, 1.0);

	CANVAS_SIZE = 900 * sf;
	SQUARE_SIZE = CANVAS_SIZE/16;
	CELL_BUFFER = CANVAS_SIZE/128;

	FIRE_IMG.width = 48 * sf;
	FIRE_IMG.height = 48 * sf;
};
