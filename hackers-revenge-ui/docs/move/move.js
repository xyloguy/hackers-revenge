...
function submitActions(object) {
	...
	if (email == "") {
		var message = "Please input your email!"
		alertFunction(message);
		return
	}
	if (phone == "") {
		var message = "Please input your phone number!"
		alertFunction(message);
		return
	}
	if (name == "") {
		var message = "Please input your name!"
		alertFunction(message);
		return
	}
